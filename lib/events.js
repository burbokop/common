...
// Example: common.forwardEvents(from, to);
// Example: common.forwardEvents(from, to, 'eventName');
// Example: common.forwardEvents(from, to, { eventName: 'newEventName' });
// Example: common.forwardEvents(from, to, ['eventName1', 'eventName2']);
...
// Forward events from one EventEmitter to another
//   to - EventEmitter, to emit event on
//   events - <string[]>, string or object, events names
